  ...
  return (
    <div className="max-w-5xl mx-auto mt-10 bg-gray-800 text-white p-6 rounded-lg">
      ...
      <div className="flex gap-4 border-b border-gray-600 mb-6 pb-2">
        <button onClick={() => setAktifSekme("scalping")} className={`px-4 py-2 rounded ${aktifSekme === "scalping" ? "bg-blue-600" : "bg-gray-700"}`}>Scalping</button>
        <button onClick={() => setAktifSekme("yatirim")} className={`px-4 py-2 rounded ${aktifSekme === "yatirim" ? "bg-blue-600" : "bg-gray-700"}`}>Yatırım</button>
        <button onClick={() => setAktifSekme("kisisel")} className={`px-4 py-2 rounded ${aktifSekme === "kisisel" ? "bg-blue-600" : "bg-gray-700"}`}>Kişisel Ayarlar</button>
      </div>
